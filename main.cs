...
class MainClass {
	...
	public static string RemoveECHO(string text) { text = text.Replace("echo ", ""); var oRegEx = new System.Text.RegularExpressions.Regex("<[^>]+>"); return oRegEx.Replace(text, string.Empty); }
	static void tre(){
		term();
	} 
	static void term(){
